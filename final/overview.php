        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <div class="container">
                        <form class="mx-auto" id="search-form" method="post" action="overview.php">
                            <div class="input-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="save-new-image-modal-form" method="post" action="overview.php">
                            <div class="mb-3">
        ...
        <div class="modal fade" id="manage-image-modal" tabindex="-1" aria-labelledby="manage-image-modal-label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="manage-image-modal-form" method="post" action="overview.php">
                            <div class="mb-3">
                                <label for="image-url" class="col-form-label">Image URL:</label>
